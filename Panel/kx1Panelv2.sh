...
menu() {
    clear
    echo -e "${GREEN}=== 1Panel v2 开心版 管理菜单 ===${RESET}"
    echo -e "${GREEN}1) 安装部署 v2${RESET}"
    echo -e "${GREEN}2) 更新到最新${RESET}"
    echo -e "${GREEN}3) 卸载 1Panel v2 开心版${RESET}"
    ...
    case $choice in
        ...
        2)
            ...
            curl https://resource.1panel.jp/1panel/package/v2/update.sh | bash
            pause
            ;;
        3)

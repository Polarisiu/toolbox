...
SUB_MENU[7]="67 系统清理|68 系统快照恢复|69 系统备份|70 一键重装系统|71 系统组件|72 开发环境|73 添加SWAP|74 DNS管理|75 工作区管理|76 系统监控|77 防火墙管理|78 Fail2ban|79 集群管理|80 解压文件|81 定时任务"
...
execute_choice() {
    case "$1" in
        ...
        69) bash <(curl -fsSL https://raw.githubusercontent.com/sistarry/toolbox/main/VPS/vpsremo.sh) ;;
        ...
        79) bash <(curl -fsSL https://raw.githubusercontent.com/sistarry/toolbox/main/VPS/group.sh) ;;
        ...
        101) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/GProxy.sh) ;;
        102) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/AkileDNS.sh) ;;
        88)

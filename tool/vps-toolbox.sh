...
SUB_MENU[1]="1 更新系统|2 系统信息|3 修改root密码|4 root密码登录管理|5 root公钥登录管理|6 修改SSH端口|7 修改时区|8 时间同步|9 切换v4V6|10 开放所有端口|11 更换系统源|12 DDdebian13|13 DDwindows10|14 DDNAT|15 DD飞牛|16 修改语言|17 修改主机名|18 美化命令|19 VPS重启"
...
SUB_MENU[9]="87 脚本短链|89 网站部署|90 ClawBot|91 Emby反代|92 GProxy加速|93 Akile优先DNS|94 1panelapps管理|95 SubsCheck|96 关闭V1SSH|97 卸载哪吒Agent|98 卸载komariAgent"
...
execute_choice() {
    case "$1" in
        ...
        12) bash <(curl -fsSL https://raw.githubusercontent.com/sistarry/toolbox/main/VPS/Debian13.sh) ;;
        ...
        30) wget -N --no-check-certificate https://raw.githubusercontent.com/flame1ce/hysteria2-install/main/hysteria2-install-main/hy2/hysteria.sh && bash hysteria.sh ;;
		...
		90) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Clawbot.sh) ;;

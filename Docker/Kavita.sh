...
install_app() {
    ...
    read -p "请输入 Manga 目录路径(例如/opt/kavita/Manga): " MANGA_DIR
    read -p "请输入 Comics 目录路径(例如/opt/kavita/Comics): " COMICS_DIR
    read -p "请输入 Books 目录路径(例如/opt/kavita/Books): " BOOKS_DIR

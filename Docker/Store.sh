...
declare -A apps=(
    ...
    [6,39]="MDC-NG AV刮削"
    [6,40]="FlareSolverr绕过Cloudflare反爬虫保护"
    [7,1]="Foxel图片管理"
    [7,2]="兰空图床(MySQL)"
    [7,3]="兰空图床"
    [7,4]="图片API(兰空图床)"
...
declare -A commands=(
    ...
    [6,39]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/MDCNG.sh)'
    [6,40]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/FlareSolverr.sh)'
    ...
    [12,7]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/OpenClaw.sh)'

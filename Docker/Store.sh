...
declare -A commands=(
    ...
    [1,3]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/dockcompback.sh)'
    ...
    [1,5]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/dockerupdate.sh)'
    ...
    [4,5]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/UptimeKuma.sh)'
    [4,6]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/NodeSeeker.sh)'
    [4,7]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Beszel.sh)'
    [4,8]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/xtrafficdash.sh)'
    [4,9]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/nezhav0Argo.sh)'
    [4,10]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/changedetection.sh)'
    [4,11]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/main/Pulse.sh)'
    [5,1]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Panel.sh)'
    ...
    [5,23]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/eoossh.sh)'
    [5,24]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Navlink.sh)'
    [5,25]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/EasyNode.sh)'
    [5,26]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Epicgamer.sh)'
    ...
    [7,2]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/stb.sh)'
    [7,3]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/lskyprodb.sh)'
    [7,4]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/lskypro.sh)'
    [7,5]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/apitu.sh)'
    [7,6]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/EasyImage.sh)'
    [7,7]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/tuapi.sh)'
    [7,8]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/EasyImg.sh)'
    [7,9]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/OneImg.sh)'
    [7,10]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/NodeImage.sh)'
